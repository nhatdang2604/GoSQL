...
func NewFromStatement() *FromStatement {
  return &FromStatement{}
}


func (p *FromStatement) GetDatabaseName() string {
  return p.DatabaseName
}

func (p *FromStatement) GetTableName() string {
  return p.TableName
}
func (p *FromStatement) Read(ctx context.Context, iprot thrift.TProtocol) error {
...
func (p *FromStatement)  ReadField1(ctx context.Context, iprot thrift.TProtocol) error {
...
func (p *FromStatement)  ReadField2(ctx context.Context, iprot thrift.TProtocol) error {
  if v, err := iprot.ReadString(ctx); err != nil {
...
func (p *FromStatement) Write(ctx context.Context, oprot thrift.TProtocol) error {
  if err := oprot.WriteStructBegin(ctx, "FromStatement"); err != nil {
...
func (p *FromStatement) writeField1(ctx context.Context, oprot thrift.TProtocol) (err error) {
...
func (p *FromStatement) writeField2(ctx context.Context, oprot thrift.TProtocol) (err error) {
...
func (p *FromStatement) Equals(other *FromStatement) bool {
  if p == other {
    return true
...
func (p *FromStatement) String() string {
  if p == nil {
    return "<nil>"
  }
  return fmt.Sprintf("FromStatement(%+v)", *p)
}

func (p *FromStatement) Validate() error {
  return nil
}
