...
func Usage() {
  ...
  fmt.Fprintln(os.Stderr, "  SelectResponse query(SelectRequest request)")
  fmt.Fprintln(os.Stderr)
  os.Exit(0)
}
...
func main() {
  ...
  client := select.NewSelectServiceClient(thrift.NewTStandardClient(iprot, oprot))
  ...
  case "query":
    ...
    argvalue0 := select.NewSelectRequest()
