...
func Usage() {
  ...
  fmt.Fprintln(os.Stderr, "  InsertResponse query(InsertRequest request)")
  fmt.Fprintln(os.Stderr)
  os.Exit(0)
}
...
func main() {
  ...
  client := insert.NewInsertServiceClient(thrift.NewTStandardClient(iprot, oprot))
  ...
  case "query":
    ...
    argvalue0 := insert.NewInsertRequest()
