...
//  - Value
type Column struct {
  Datatype datatype.DatatypeTag `thrift:"datatype,1,required" db:"datatype" json:"datatype"`
...
func (p *Column) GetDatatype() datatype.DatatypeTag {
  return p.Datatype
}
